        ...
        try {
            ...
            $result = $datosgeneralesPM->map(function ($item){
                return [
                    ...
                    'socios' => $item->socios,
                    'cuenta_permiso' => $item->cuenta_permiso ? 'Sí' : 'No',
                    'motivo_no_cuenta' => $item->motivo_no_cuenta,
                    'cuentaemb_ma' => $item->cuentaemb_ma ? 'Sí' : 'No',
                    ...
                    'cuentaemb_me' => $item->cuentaemb_me ? 'Sí' : 'No',
    ...
    public function store(Request $request)
    {
        try {
            $data = $request->validate([
                ...
                'motivono_cuenta_embma' => 'nullable|string|max:200',
                ...
                'motivono_cuenta_embme' => 'nullable|string|max:200',
                'cant_emb_me' => 'nullable|integer',
                'cant_motor_me' => 'nullable|integer',
                'tipos_motores_me' => 'nullable|string|max:50',
            ]);
        ...
        try {
            ...
            $result = [
                'id' => $datosgeneralesPM->id,
                    ...
                    'cuenta_permiso' => $datosgeneralesPM->cuenta_permiso ? 'Sí' : 'No',
                    'motivo_no_cuenta' => $datosgeneralesPM->motivo_no_cuenta,
                    'cuentaemb_ma' => $datosgeneralesPM->cuentaemb_ma ? 'Sí' : 'No',
                    ...
                    'cuentaemb_me' => $datosgeneralesPM->cuentaemb_me ? 'Sí' : 'No',
