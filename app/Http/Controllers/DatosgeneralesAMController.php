        ...
        try {
            ...
            $result = $datosgeneralesAM->map(function ($item){
                return [
                    ...
                    'email' => $item->email,
                    'especies_producen' => $item->especies_producen,
    ...
    public function store(Request $request)
    {
        try {
            $data = $request->validate([
                ...
                'especies_producen' => 'required|string|max:200',
    ...
    public function show($id)
    {
        try {
            ...
            $result = [
                ...
                'region_id' => $datosgeneralesAM->regiones->id,
                'distrito_id' => $datosgeneralesAM->distritos->id,
                'muni_id' => $datosgeneralesAM->municipios->id,
                'local_id' => $datosgeneralesAM->localidades->id,
                'email' => $datosgeneralesAM->email,
                'especies_producen' => $datosgeneralesAM->especies_producen,
