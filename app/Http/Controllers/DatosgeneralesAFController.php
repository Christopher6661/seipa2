        ...
        try {
            ...
            $result = $datosgeneralesAF->map(function ($item){
                return [
                    ...
                    'especies_producen' => $item->especie_producen,
    ...
    public function store(Request $request)
    {
        try {
            $data = $request->validate([
                ...
                'especies_producen' => 'required|string|max:100',
    ...
    public function show($id)
    {
        try {
            ...
            $result = [
                ...
                'localidad_id' => $datosgeneralesAF->localidades->id,
                'municipio_id' => $datosgeneralesAF->municipios->id,
                'distrito_id' => $datosgeneralesAF->distritos->id,
                'region_id' => $datosgeneralesAF->regiones->id,
                'grupo_sanguineo' => $datosgeneralesAF->grupo_sanguineo,
                'especies_producen' => $datosgeneralesAF->especie_producen,
