        ...
        try {
            ...
            $result = $datosgeneralesPF->map(function ($item) {
                return [
                    ...
                    'cuenta_emb_mayor' => $item->cuenta_emb_mayor ? 'Sí' : 'No',
                    ...
                    'cuenta_emb_menores' => $item->cuenta_emb_menores ? 'Sí' : 'No',
    ...
    public function show($id)
    {
        try {
            ...
            $result = [
                ...
                'cuenta_permiso' => $datosgeneralesPF->cuenta_permiso ? 'Sí' : 'No',
                'motivo_no_cuenta' => $datosgeneralesPF->motivo_no_cuenta,
                'cuenta_emb_mayor' => $datosgeneralesPF->cuenta_emb_mayor ? 'Sí' : 'No',
                ...
                'cuenta_emb_menores' => $datosgeneralesPF->cuenta_emb_menores ? 'Sí' : 'No',
