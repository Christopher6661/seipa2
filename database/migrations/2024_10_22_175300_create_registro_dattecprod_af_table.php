...
return new class extends Migration
{
    ...
    {
        Schema::create('registro_dattecprod_af', function (Blueprint $table) {
            $table->id();
            ...
            $table->boolean('modelo_otro')->default(false);
            ...
            $table->enum('tipo_asistenciatec', ['Asesor pagado', 'Otorgado por la institucion']);
    ...
    {
        Schema::dropIfExists('registro_dattecprod_af');
    }
};
