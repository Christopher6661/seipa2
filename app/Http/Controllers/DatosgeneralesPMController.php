        ...
        try {
            ...
            $result = $datosgeneralesPM->map(function ($item){
                return [
                    ...
                    'cant_artepesca' => $item->cant_artepesca,
    ...
    public function store(Request $request)
    {
        try {
            $data = $request->validate([
                ...
                'cant_artepesca' => 'required|integer',
        ...
        try {
            ...
            $result = [
                'id' => $datosgeneralesPM->id,
                    ...
                    'region_id' => $datosgeneralesPM->Region->id,
                    'distrito_id' => $datosgeneralesPM->Distrito->id,
                    'municipio_id' => $datosgeneralesPM->Municipio->id,
                    'localidad_id' => $datosgeneralesPM->Localidad->id,
                    'zona_pesca' => $datosgeneralesPM->zona_pesca,
                    'cuota_captura' => $datosgeneralesPM->cuota_captura,
                    'cant_artepesca' => $datosgeneralesPM->cant_artepesca,
                    'etnia_id' => $datosgeneralesPM->Etnia->id,
