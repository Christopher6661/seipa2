    ...
    public function show($id)
    {
        try {
            ...
            $result = [
                ...
                'paraje' => $UbicacionFisicaAM->paraje,
                'domicilio' => $UbicacionFisicaAM->domicilio,
                'codigo_postal' => $UbicacionFisicaAM->codigo_postal,
                'telefono' => $UbicacionFisicaAM->telefono,
                'region_id' => $UbicacionFisicaAM->regiones->id,
                'distr_id' => $UbicacionFisicaAM->distritos->id,
                'muni_id' => $UbicacionFisicaAM->municipios->id,
                'local_id' => $UbicacionFisicaAM->localidades->id,
