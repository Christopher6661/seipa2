    ...
    public function store(Request $request)
    {
        try {
            $data = $request->validate([
                'estanque_rustico_sup' => 'required|float',
                'estanque_rustico_vol' => 'required|float',
                'estanque_rustico_can' => 'required|string|max:50',
                'recubiertomem_sup' => 'required|float',
                'recubiertomem_vol' => 'required|float',
                'recubiertomem_can' => 'required|string|max:50',
                'geomallagallamina_sup' => 'required|float',
                'geomallagallamina_vol' => 'required|float',
                'geomallagallamina_can' => 'required|string|max:50',
                'tipo_circular_sup' => 'required|float',
                'tipo_circular_vol' => 'required|float',
                'tipo_circular_can' => 'requiredstring|max:50',
                'tipo_rectangular_sup' => 'required|float',
                'tipo_rectangular_vol' => 'required|float',
                'tipo_rectangular_can' => 'requiredstring|max:50',
                'jaula_flotante_sup' => 'required|float',
                'jaula_flotante_vol' => 'required|float',
                'jaula_flotante_can' => 'required|string|max:50',
                'cercas_encierros_sup' => 'required|float',
                'cercas_encierros_vol' => 'required|float',
                'cercas_encierros_can' => 'required|string|max:50',
                'otro_superficie' => 'required|float',
                'otro_volumen' => 'required|float',
