    ...
    public function show($id)
    {
        try {
            ...
            $result = [
                ...
                'userprofile_id' => $UbicacionFisicaAF->perfil_usuario->id,
                ...
                'region_id' => $UbicacionFisicaAF->Region->id,
                'distr_id' => $UbicacionFisicaAF->Distrito->id,
                'muni_id' => $UbicacionFisicaAF->Municipio->id,
                'local_id' => $UbicacionFisicaAF->Localidad->id,
