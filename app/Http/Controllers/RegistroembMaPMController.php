...
class RegistroembMaPMController extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            $data = $request->validate([
                ...
                'año_construccion' => 'required|string|max:255',
                ...
                'medida_eslora_mts' => 'required|numeric',
                'medida_manga_mts' => 'required|numeric',
                'medida_puntal_mts' => 'required|numeric',
                'medida_calado_mts' => 'required|numeric',
                'medida_arquneto_mts' => 'required|numeric',
                'capacidadbodega_mts' => 'required|numeric',
                'capacidad_carga_ton' => 'required|numeric',
                'capacidad_tanque_lts' => 'required|numeric',
    ...
    public function show($id)
    {
        try {
            ...
            $result = [
                    'id' => $embMayorPM->id,
                    'userprofile_id' => $embMayorPM->perfil_usuario->id,
                    ...
                    'tipo_cubierta_id' => $embMayorPM->tipocubierta->id,
                    'material_casco_id' => $embMayorPM->materialcasco->id,
